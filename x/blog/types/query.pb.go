...
func init() {
	proto.RegisterType((*QueryParamsRequest)(nil), "auagho.blog.blog.QueryParamsRequest")
	proto.RegisterType((*QueryParamsResponse)(nil), "auagho.blog.blog.QueryParamsResponse")
	proto.RegisterType((*QueryPostsRequest)(nil), "auagho.blog.blog.QueryPostsRequest")
	proto.RegisterType((*QueryPostsResponse)(nil), "auagho.blog.blog.QueryPostsResponse")
	proto.RegisterType((*QueryGetCommentRequest)(nil), "auagho.blog.blog.QueryGetCommentRequest")
	proto.RegisterType((*QueryGetCommentResponse)(nil), "auagho.blog.blog.QueryGetCommentResponse")
	proto.RegisterType((*QueryAllCommentRequest)(nil), "auagho.blog.blog.QueryAllCommentRequest")
	proto.RegisterType((*QueryAllCommentResponse)(nil), "auagho.blog.blog.QueryAllCommentResponse")
	proto.RegisterType((*QueryCommentsRequest)(nil), "auagho.blog.blog.QueryCommentsRequest")
	proto.RegisterType((*QueryCommentsResponse)(nil), "auagho.blog.blog.QueryCommentsResponse")
}
...
var fileDescriptor_6e22cd6d352f3384 = []byte{
	...
	,
}
...
func (c *queryClient) Params(ctx context.Context, in *QueryParamsRequest, opts ...grpc.CallOption) (*QueryParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/auagho.blog.blog.Query/Params", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) Posts(ctx context.Context, in *QueryPostsRequest, opts ...grpc.CallOption) (*QueryPostsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/auagho.blog.blog.Query/Posts", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) Comment(ctx context.Context, in *QueryGetCommentRequest, opts ...grpc.CallOption) (*QueryGetCommentResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/auagho.blog.blog.Query/Comment", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) CommentAll(ctx context.Context, in *QueryAllCommentRequest, opts ...grpc.CallOption) (*QueryAllCommentResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/auagho.blog.blog.Query/CommentAll", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) Comments(ctx context.Context, in *QueryCommentsRequest, opts ...grpc.CallOption) (*QueryCommentsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/auagho.blog.blog.Query/Comments", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Params_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/auagho.blog.blog.Query/Params",
	}
...
func _Query_Posts_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/auagho.blog.blog.Query/Posts",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_Comment_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/auagho.blog.blog.Query/Comment",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_CommentAll_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/auagho.blog.blog.Query/CommentAll",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Query_Comments_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/auagho.blog.blog.Query/Comments",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "auagho.blog.blog.Query",
