...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/auagho/blog/blog/comment
   */
  queryCommentAll = (
    query?: {
   ...
   * @request GET:/auagho/blog/blog/comments/{id}
   */
  queryComments = (
    id: string,
    query?: {
    ...
    this.request<BlogQueryCommentsResponse, RpcStatus>({
      path: `/auagho/blog/blog/comments/${id}`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/auagho/blog/blog/params
   */
  queryParams = (params: RequestParams = {}) =>
    this.request<BlogQueryParamsResponse, RpcStatus>({
      path: `/auagho/blog/blog/params`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/auagho/blog/blog/posts
   */
  queryPosts = (
    query?: {
      "pagination.key"?: string;
